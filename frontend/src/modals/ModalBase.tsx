import { useRef, ReactNode, CSSProperties, ChangeEvent, FocusEvent } from 'react';
...
export const QUICK_BTN_STYLE: CSSProperties = {
 ...
 */
export function PropertyOptions({ properties, placeholder, placeholderValue = '' }: PropertyOptionsProps) {
  return (
    <>
 ...
 */
export function DateInput({ value, onChange, required, id, style, ...rest }: DateInputProps) {
